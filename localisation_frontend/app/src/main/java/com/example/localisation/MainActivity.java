...
public class MainActivity extends AppCompatActivity {
    ...
    String insertUrl = "http://192.168.11.102/localisation/createPosition.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnSwitchToMapsActivity = findViewById(R.id.btnShowMap);
    ...
    void addPosition(final double lat, final double lon) {
        StringRequest request = new StringRequest(Request.Method.POST, insertUrl, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("latitude", lat + ""); params.put("longitude", lon + "");
